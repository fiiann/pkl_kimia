...
<?php
	...
	if(!isset($_POST['edit'])){
		...
		if ($validJudul) {
			...
			$query = "UPDATE tr1 SET  judul='".$judul."' WHERE nim='".$nim."'";
...
<div class="row">
			...
			<div class="panel-body">
              ...
              <span class="label label-success"><?php if(isset($pesan_sukses)) echo $pesan_sukses;?></span>
							...
							<div class="form-group">
								...
								<!-- <textarea class="form-control" name="judul" rows="5" cols="150" maxlength="1000" size="130" placeholder="Judul tr1" required autofocus value="<?php echo $judul; ?>">

								</textarea> -->
								<input class="form-control" type="text" name="judul" maxlength="200" size="200" placeholder="Judul tr1" required autofocus value="<?php if(isset($judul)){echo $judul;} ?>">
							</div>
	...
	&nbsp;&nbsp;&nbsp;<a href="daftar_judul_tr1.php"><button class="btn btn-info">Kembali ke Daftar Judul</button></a>
</div>
