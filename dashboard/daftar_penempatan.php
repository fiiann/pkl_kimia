...
<html>
<head>
	<title>Daftar Penempatan Lab</title>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover" id="tabelku">
              ...
              <?php
                // Assign a query
                if (($status=="petugas")) {
                  $query = "SELECT * FROM pkt p INNER JOIN mahasiswa m ON p.nim=m.nim LEFT JOIN lab ON p.flag_lab=lab.idlab WHERE p.flag_lab IS NOT NULL ORDER BY lab.idlab  ";
                }
                elseif ($status=="dosen"){
