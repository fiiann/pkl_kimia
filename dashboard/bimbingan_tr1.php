	...
	-->
	<?php
		$site_name = "Distribusi Pembimbing TR 1";
		...
		if(!isset($_POST['edit'])){
			$query = " SELECT * FROM tr1 left join mahasiswa m on tr1.nim=m.nim left join lab on tr1.idlab_tr1=lab.idlab WHERE id_tr1='".$id_tr1."'";
			// Execute the query
			...
			if ($validNip && $validNip2 && $validNip3) {
				...
				if (!$hasil) {
					...
					$button='<a href="daftar_bimbingan_tr1.php"><button class="btn btn-info">Kembali ke daftar bimbingan</button></a>';
				}
				// $pesan_sukses="berhasil update bimbingan";
			}
			else{
					...
					<div class="row">
						<div class="col-md-12">
							<form method="POST" role="form" autocomplete="on" action="">
								...
								<div class="form-group">
									<label>Lab</label>&nbsp;<span class="label label-warning">* <?php if(isset($errorid_tr1)) echo $errorid_tr1;?></span>
									<input class="form-control" type="text" readonly value="<?php echo $nama_lab; ?>">
								</div>
								<div class="form-group">
