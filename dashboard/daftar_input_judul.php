					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-hover" id="tabelku">
								...
								<?php
									// Assign a query
									if ($status=="petugas") {
										$query = "SELECT * FROM pkt INNER JOIN mahasiswa ON pkt.nim=mahasiswa.nim LEFT JOIN lab ON pkt.flag_lab=lab.idlab WHERE pkt.judul IS NULL ORDER BY pkt.flag_lab   ";
									}elseif ($status=="dosen") {
