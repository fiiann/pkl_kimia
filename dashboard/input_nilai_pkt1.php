					...
					<div class="col-md-12">
						...
						<!-- <form method="POST" role="form" autocomplete="on" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> -->
							...
							<div class="form-group">
								...
								<input class="form-control" type="number" name="nilai_praktikum" min="0" max="100" placeholder="0-100" required value="<?php if(isset($n_praktikum)){echo $n_praktikum;} if(!$sukses&&$validnilai_praktikum){echo $nilai_praktikum;} ?>">

							</div>

							<div class="form-group">
								<label>Nilai Laporan</label>&nbsp;<span class="label label-warning">* <?php if(isset($errornilai_laporan)) echo $errornilai_laporan;?></span>
								<input class="form-control" type="number" name="nilai_laporan" min="0" max="100" placeholder="0-100" required value="<?php if(isset($n_laporan)){echo $n_laporan;} if(!$sukses&&$validnilai_laporan){echo $nilai_laporan;} ?>">
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control" type="number" name="nilai_presentasi" min="0" max="100" placeholder="0-100" required value="<?php if(isset($n_presentasi)){echo $n_presentasi;}if(!$sukses&&$validnilai_presentasi){echo $nilai_presentasi;} ?>">
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control" type="date" name="tgl_lulus" required  >
							</div>
							<div class="form-group">
