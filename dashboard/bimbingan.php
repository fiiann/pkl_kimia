<?php
	$site_name = "Distribusi pembimbing PKT";
				...
				<div class="row">
					<div class="col-md-12">
						<form method="POST" role="form" autocomplete="on" action="">
							...
							<div class="form-group">
								<label>Lab</label>&nbsp;<span class="label label-warning">* <?php if(isset($errorNim)) echo $errorNim;?></span>
							...
							<div class="form-group">
								...
								<?php
										$querykat = "select * from dosen where idlab='".$lab."'";
