...
-->
<?php
	$site_name = "Input Persentase Progress";
    ...
    $query06 = " SELECT persentase_tr1 FROM nilai_komponen_tr1 WHERE id_komponen_tr1=12";
		...
		$total = $persentase_bahasa+$persentase_substansi+$persentase_media+$persentase_materi+$persentase_analisis+$persentase_pengetahuan;
		if ($total != 100) {
		...
		if ($validnilai_bahasa && $validNilai_substansi && $validnilai_media && $validnilai_materi && $validnilai_analisis && $validnilai_pengetahuan && $validTotal) {
					...
					<div class="col-md-12">
						<form method="POST" role="form" autocomplete="on" action="">
							...
							<div class="form-group">
								...
								<input class="form-control" type="number" name="persentase_bahasa" min="0" max="100" placeholder="edit nilai" required value="<?php if(isset($persentase_bahasa)){echo $persentase_bahasa;} ?>">
							</div>

							<div class="form-group">
								<label>Substansi</label>&nbsp; <span class="label label-warning">*<?php if(isset($errornilai_substansi)) echo $errornilai_substansi;?></span>
								<input class="form-control" type="number" name="persentase_substansi" min="0" max="100" placeholder="edit nilai" required value="<?php if(isset($persentase_substansi)){echo $persentase_substansi;} ?>">
							</div>
							<div class="form-group">
								<label>Penggunaan Media</label>&nbsp; <span class="label label-warning">*<?php if(isset($errornilai_media)) echo $errornilai_media;?></span>
								<input class="form-control" type="number" name="persentase_media" min="0" max="100" placeholder="edit nilai" required value="<?php if(isset($persentase_media)){echo $persentase_media;} ?>">
							</div>

							<div class="form-group">
								<label>Penguasaan Materi</label>&nbsp; <span class="label label-warning">*<?php if(isset($errornilai_materi)) echo $errornilai_materi;?></span>
								<input class="form-control" type="number" name="persentase_materi" min="0" max="100" placeholder="edit nilai" required value="<?php if(isset($persentase_materi)){echo $persentase_materi;} ?>">
							</div>
							<div class="form-group">
								...
								<input class="form-control" type="number" name="persentase_pengetahuan" min="0" max="100" placeholder="edit nilai" required value="<?php if(isset($persentase_pengetahuan)){echo $persentase_pengetahuan;} ?>">
							</div>
