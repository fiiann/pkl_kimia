...
-->
<?php
	$site_name='Input persentase nilai outline';
    ...
    $query07 = " SELECT persentase_tr1 FROM nilai_komponen_tr1 WHERE id_komponen_tr1=7";
		...
		$total = $persentase_identifikasi+$persentase_rumusan+$persentase_tujuan+$persentase_metodologi+$persentase_hipotesis+$persentase_analisis+$persentase_kontrak;
		if ($total != 100) {
		...
		if ($validnilai_identifikasi && $validNilai_rumusan && $validnilai_tujuan && $validnilai_metodologi && $validnilai_hipotesis && $validnilai_analisis && $validnilai_kontrak && $validTotal) {
	...
	<div class="col-md-6">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				Update Data Persentase Nilai Outline
			</div>
					...
					<div class="col-md-12">
						<form method="POST" role="form" autocomplete="on" action="">
							...
							<div class="form-group">
								...
								<input class="form-control" type="number" name="persentase_identifikasi" min="0" max="100" placeholder="edit nilai" required value="<?php if(isset($persentase_identifikasi)){echo $persentase_identifikasi;} ?>">
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control" type="number" name="persentase_rumusan" min="0" max="100" placeholder="edit nilai" required value="<?php if(isset($persentase_rumusan)){echo $persentase_rumusan;} ?>">
							</div>
							<div class="form-group">
								<label>Nilai Tujuan</label>&nbsp; <span class="label label-warning">*<?php if(isset($errornilai_tujuan)) echo $errornilai_tujuan;?></span>
								<input class="form-control" type="number" name="persentase_tujuan" min="0" max="100" placeholder="edit nilai" required value="<?php if(isset($persentase_tujuan)){echo $persentase_tujuan;} ?>">
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control" type="number" name="persentase_metodologi" min="0" max="100" placeholder="edit nilai" required value="<?php if(isset($persentase_metodologi)){echo $persentase_metodologi;} ?>">
							</div>
							<div class="form-group">
								...
								<input class="form-control" type="number" name="persentase_hipotesis" min="0" max="100"" placeholder="edit nilai" required value="<?php if(isset($persentase_hipotesis)){echo $persentase_hipotesis;} ?>">
							</div>

							<div class="form-group">
								<label>Nilai Analisis</label>&nbsp; <span class="label label-warning">*<?php if(isset($errornilai_analisis)) echo $errornilai_analisis;?></span>
								<input class="form-control" type="number" name="persentase_analisis" min="0" max="100" placeholder="edit nilai" required value="<?php if(isset($persentase_analisis)){echo $persentase_analisis;} ?>">
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control" type="number" name="persentase_kontrak" min="0" max="100" placeholder="edit nilai" required value="<?php if(isset($persentase_kontrak)){echo $persentase_kontrak;} ?>">
							</div>
							<div class="form-group">
