					...
					<div class="col-md-12">
						...
						<form method="POST" role="form" autocomplete="on" action="">
							...
							<div class="form-group">
								...
								<input class="form-control" type="text" name="nilai_identifikasi" maxlength="3" size="30" placeholder="0-100" required value="<?php if(isset($nilai_identifikasi)){echo $nilai_identifikasi;} if(!$sukses&&$validnilai_identifikasi){echo $nilai_identifikasi;} ?>">

							</div>

							<div class="form-group">
								<label>Rumusan Masalah</label>&nbsp;<span class="label label-warning">* <?php if(isset($errornilai_rumusan)) echo $errornilai_rumusan;?></span>
								<input class="form-control" type="text" name="nilai_rumusan" maxlength="3" size="30" required value="<?php if(isset($nilai_rumusan)){echo $nilai_rumusan;} if(!$sukses&&$validnilai_rumusan){echo $nilai_rumusan;} ?>">
							</div>

							<div class="form-group">
								<label>Tujuan</label>&nbsp;<span class="label label-warning">* <?php if(isset($errornilai_tujuan)) echo $errornilai_tujuan;?></span>
								<input class="form-control" type="text" name="nilai_tujuan" maxlength="3" size="30" placeholder="0-100" required value="<?php if(isset($nilai_tujuan)){echo $nilai_tujuan;}if(!$sukses&&$validnilai_tujuan){echo $nilai_tujuan;} ?>">
							</div>
							<div class="form-group">
								<label>Metodologi</label>&nbsp;<span class="label label-warning">* <?php if(isset($errornilai_metodologi)) echo $errornilai_metodologi;?></span>
								<input class="form-control" type="text" name="nilai_metodologi" maxlength="3" size="30" placeholder="0-100" required value="<?php if(isset($nilai_metodologi)){echo $nilai_metodologi;}if(!$sukses&&$validnilai_metodologi){echo $nilai_metodologi;} ?>">
							</div>
							<div class="form-group">
								<label>Hipotesis</label>&nbsp;<span class="label label-warning">* <?php if(isset($errornilai_hipotesis)) echo $errornilai_hipotesis;?></span>
								<input class="form-control" type="text" name="nilai_hipotesis" maxlength="3" size="30" placeholder="0-100" required value="<?php if(isset($nilai_hipotesis)){echo $nilai_hipotesis
							...
							<div class="form-group">
								...
								<input class="form-control" type="text" name="nilai_kontrak" maxlength="3" size="30" placeholder="0-100" required value="<?php if(isset($nilai_kontrak)){echo $nilai_kontrak;}if(!$sukses&&$validnilai_kontrak){echo $nilai_kontrak;} ?>">
							</div>
							<div class="form-group">
						...
						<div class="form-group">
								<a href="nilai_tr1.php"><button class="btn btn-info">Kembali ke Daftar Nilai PKT</button></a>
							</div>
					</div>
