		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover">
						...
						<?php
							// Assign a query
							if ($status=="petugas") {
								$query = "SELECT * FROM tr1 t INNER JOIN mahasiswa m ON t.nim=m.nim  WHERE t.idlab_tr1 IS NULL ORDER BY m.nama LIMIT 10";
							}elseif ($status=="dosen"){
                ...
                if ($row->idlab_tr1 != null) {
                  ...
                  echo "<td align='center'><a href='edit_lab1.php?nim=".$row->nim."' class='btn btn-info btn-s' role='button'>Tempatkan</a></td>";
                }
								if ($status=="petugas") {
								echo "<td align='center'>
										<a href='edit_lab1.php?nim=".$row->nim."'><i class='fa fa-edit'></i></a>&nbsp;
