					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-hover" id="tabelku">
						  ...
						  <?php
						    ...
						    if (($status=="petugas")) {
						      $query = "SELECT * FROM tr1 p INNER JOIN mahasiswa m ON p.nim=m.nim LEFT JOIN dosen d ON p.nip1=d.nip	WHERE p.nip1 IS NULL ORDER BY nama LIMIT 10";
						    }elseif ($status=="anggota"){
						      ...
						      $query = "SELECT * FROM tr1 INNER JOIN mahasiswa m ON p.nim=m.nim LEFT JOIN dosen d ON p.dosen_pembimbing=d.nip WHERE d.nip='".$dosen->nip."' ORDER BY nama LIMIT 10";
						    }elseif($status=='lab') {
						      $query = "SELECT * FROM tr1 p INNER JOIN mahasiswa m ON p.nim=m.nim LEFT JOIN dosen ON p.nip1=dosen.nip WHERE p.idlab_tr1='".$lab->idlab."' AND p.nip1 IS NULL LIMIT 10";
						    }
