					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-hover" id="tabelku">
						  ...
						  <?php
						    ...
						    if (($status=="petugas")) {
						      $query = "SELECT * FROM tr1 p INNER JOIN mahasiswa m ON p.nim=m.nim LEFT JOIN dosen d ON p.nip1=d.nip	LEFT JOIN lab ON p.idlab_tr1=lab.idlab WHERE p.nilai_huruf IS NULL ORDER BY nama   ";
						    }elseif ($status=="anggota"){
						      ...
						      $query = "SELECT * FROM tr1 p INNER JOIN mahasiswa m ON p.nim=m.nim LEFT JOIN dosen d ON p.nip1=d.nip WHERE d.nip='".$dosen->nip."' AND p.nilai_huruf IS NULL ORDER BY nama   ";
						    }elseif($status=='lab') {
						      $query = "SELECT * FROM tr1 p INNER JOIN mahasiswa m ON p.nim=m.nim LEFT JOIN dosen d ON p.nip1=d.nip LEFT JOIN lab ON p.idlab_tr1=lab.idlab WHERE p.idlab_tr1='".$lab->idlab."' AND p.nip1 IS NULL ORDER BY nama   ";
						    }
