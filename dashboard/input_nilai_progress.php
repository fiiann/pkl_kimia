<?php
	...
	if (!isset($_POST['daftar'])) {
		...
		if ($validnilai_bahasa && $validnilai_substansi && $validnilai_media && $validnilai_materi && $validnilai_analisis && $validnilai_pengetahuan ) {
			...
			if ($nilai_tr1 >= 80) {
				$nilai_huruf = "A";
			}elseif ($nilai_tr1 < 80 and $nilai_tr1 >=60 ) {
				$nilai_huruf = "B";
			}elseif ($nilai_tr1 < 60 and $nilai_tr1 >=40) {
				$nilai_huruf = "C";
			}elseif ($nilai_tr1 < 40 and $nilai_tr1 >=20) {
				$nilai_huruf = "D";
			}elseif ($nilai_tr1 < 20 and $nilai_tr1 >=0) {
				$nilai_huruf = "E";
			}else{
				$nilai_huruf = "Tidak diketahui";
			}
			$query12 =  "UPDATE tr1 SET nilai_huruf='".$nilai_huruf."' WHERE id_tr1=$id_tr1";
			...
			$hasil10=$con->query($query10);
			$hasil11=$con->query($query11);
			$hasil12=$con->query($query12);
			if (!($hasil1 && $hasil2 && $hasil3 && $hasil4 && $hasil5 && $hasil6 && $hasil8 && $hasil9 && $hasil10 && $hasil11 && $hasil12)) {
					...
					<div class="col-md-12">
						...
						<form method="POST" role="form" autocomplete="on" action="">
							...
							<div class="form-group">
								...
								<input class="form-control" type="number" name="nilai_bahasa" min="0" max="100" placeholder="0-100" required value="<?php if(isset($nilai_bahasa)){echo $nilai_bahasa;} if(!$sukses&&$validnilai_bahasa){echo $nilai_bahasa;} ?>">

							</div>

							<div class="form-group">
								<label>Substansi</label>&nbsp;<span class="label label-warning">* <?php if(isset($errornilai_substansi)) echo $errornilai_substansi;?></span>
								<input class="form-control" type="number" name="nilai_substansi" min="0" max="100" placeholder="0-100" required value="<?php if(isset($nilai_substansi)){echo $nilai_substansi;} if(!$sukses&&$validnilai_substansi){echo $nilai_substansi;} ?>">
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control" type="number" name="nilai_media" min="0" max="100" placeholder="0-100" required value="<?php if(isset($nilai_media)){echo $nilai_media;}if(!$sukses&&$validnilai_media){echo $nilai_media;} ?>">
							</div>
							<div class="form-group">
								<label>Penguasaan Materi</label>&nbsp;<span class="label label-warning">* <?php if(isset($errornilai_materi)) echo $errornilai_materi;?></span>
								<input class="form-control" type="number" name="nilai_materi" min="0" max="100" placeholder="0-100" required value="<?php if(isset($nilai_materi)){echo $nilai_materi;}if(!$sukses&&$validnilai_materi){echo $nilai_materi;} ?>">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input class="form-control" type="number" name="nilai_pengetahuan" min="0" max="100" placeholder="0-100" required value="<?php if(isset($nilai_pengetahuan)){echo $nilai_pengetahuan;}if(!$sukses&&$validnilai_pengetahuan){echo $nilai_pengetahuan;} ?>">
							</div>
							<div class="form-group">
						...
						<div class="form-group">
								<a href="nilai_progress.php"><button class="btn btn-info">Kembali ke Daftar Nilai Progress</button></a>
							</div>
					</div>
