		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					Daftar Nilai Progress  &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                <a  name="links" href="print_daftar_nilai_progress.php"><button name="links" id="links" class="btn btn-info">Print</button></a>
				</div>
						...
						<table class="table table-striped table-bordered table-hover" id="tabelku">
						  ...
						  <?php
						    ...
						    if ($status=="petugas") {
						      ...
						      $query = "SELECT * FROM tr1 p INNER JOIN mahasiswa m ON p.nim=m.nim  WHERE p.nip1='".$dosen->nip."' AND p.nilai_progress IS NOT NULL";
						    }elseif ($status=="lab"){
