...
--
-- Host: localhost
-- Generation Time: Dec 15, 2017 at 01:52 PM
...
('24010314120045', 'Muhammad Ahsan', 'b77d7d2c9241775b5d3eed6016278199', 'kalimanah', 'purbalingga', 'garfiantoc@if.undip.ac.id', '111'),
...
(1, 'nilai_presentasi', 50),
(2, 'nilai_laporan', 25),
(3, 'nilai_praktikum', 25),
(4, 'nilai_responsi', 40);
...
CREATE TABLE `pkt` (
  ...
  `upload_krs` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `pkt` (`id_pkt`, `nim`, `nilai`, `judul`, `waktu`, `pilihan_lab1`, `pilihan_lab2`, `pilihan_lab3`, `flag_lab`, `dosen_pembimbing`, `nilai_praktikum`, `nilai_laporan`, `nilai_presentasi`, `nilai_responsi`, `nilai_huruf`, `smt`, `tgl_daftar`, `periode`, `tgl_lulus`, `periode_lulus`, `upload_transkrip`, `upload_krs`) VALUES
(1, '24010314120044', 88, 'machine learnings', '', '1', '3', '4', '1', '240103141200022221', 100, 90, 80, 0, 'A', '6', '2017-12-15 06:50:56', '16/17', '2017-12-21', '16/17', '', ''),
(2, '24010314120001', 0, NULL, '', '1', '4', '5', '4', NULL, 0, 0, 0, 0, NULL, '5', '2017-12-12 15:35:26', '16/17', '0000-00-00', '', '', ''),
(3, '24010314120045', 56, 'machine learning 1', '', '1', '2', '5', '2', '3432432', 100, 90, 80, 0, 'C', '6', '2017-12-15 06:48:52', '16/17', '2017-12-28', '18/19', '', '');
...
INSERT INTO `tr1` (`id_tr1`, `nim`, `nip1`, `nip2`, `nip3`, `idlab_tr1`, `sks`, `ipk`, `tanggal_krs`, `tanggal_daftar`, `nilai_tr1`, `nilai_huruf`, `judul`, `smt`, `periode_daftar`, `tgl_lulus`, `periode_lulus`, `nilai_outline`, `nilai_progress`, `toefl`) VALUES
(1, '24010314120044', '240103141200022221', '240103141200022222', '3432432', '1', 111, 3, '2017-12-14', '2017-12-13', NULL, NULL, NULL, 7, '16172', '0000-00-00', '', NULL, NULL, ''),
(2, '24010314120045', '3432432', '23242435999', '1111111111', '2', 100, 3, '2017-12-20', '2017-12-15', 76, NULL, 'machine learning 1', 7, '16172', '0000-00-00', '', 74, 77, '');
...
--
ALTER TABLE `nilai_tr1`
  MODIFY `id_nilai_tr1` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
--
...
--
ALTER TABLE `tr1`
  MODIFY `id_tr1` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
